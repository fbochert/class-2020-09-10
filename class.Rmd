...
```{r}
ggplot(x, aes(x = mean_age)) +
  geom_histogram(binwidth = 1) +
  xlim(30, 50) +
  labs(title = "Age Distribution in Kenya", x = "Age", y = "Frequency")
```
...
```{r}
ggplot(x, aes(x = reg_inc)) +
  geom_histogram(bins = 50) +
  scale_x_log10() +
  labs(title = "Frequency of Voter Registration Increase in Kenya", x = "Increase in Voter Registration per Community", y = "Frequency")
```
...
```{r}
ggplot(x, aes(x = treatment, y = reg_inc)) +
  geom_boxplot() +
  scale_y_log10() +
  theme(axis.text.x = element_text(angle = 45)) +
  labs(title = "Effectiveness of Treatment Methods", x = "Treatment Methods", y = "Effect on Voter Registration Increase")
```
...
```{r}
x_new <- x %>% 
  select(treatment, reg_inc) %>% 
  group_by(treatment) %>% 
  mutate(mean_increase = mean(reg_inc)) 
ggplot(x_new, aes(x = treatment, y = mean_increase)) +
  geom_col() +
  labs(title = "Mean Effects of Treatment Methods", x = "Treatment Methods", y = "Mean Increase in Voter Registration")
```
...
```{r}
ggplot(x, aes(x = reg_inc, y = treatment)) +
  geom_violin(fill = "red") + geom_boxplot() +
  scale_x_log10() +
  labs(title = "Effectiveness of Treatment Methods", x = "Increase in Voter Registration", y = "Treatment Method")
```
